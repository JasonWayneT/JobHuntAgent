...
Product Manager with 6+ years of experience scaling and stabilizing foundational capabilities for B2B SaaS platforms (~$40M ARR). Specialized in partnering with Engineering, SRE, and Security teams to eliminate structural friction and modernize infrastructure. Proven track record leading complex technical integrations, enforcing SOC 2 compliance priorities, and defining operational roadmaps that accelerate product agility without sacrificing platform scalability or trust.
